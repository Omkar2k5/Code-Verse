...
import { IconBrandTabler, IconChartBar, IconHistory, IconSettings } from "@tabler/icons-react";
...
export default function SidebarDemo() {
  ...
  const links = [
    ...
    { label: "History", href: "#", icon: (<IconHistory className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />) },
    { label: "Analysis", href: "#", icon: (<IconChartBar className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />) },
